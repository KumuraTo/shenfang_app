CREATE DATABASE  IF NOT EXISTS `salon_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `salon_db`;
...
INSERT INTO `customer` VALUES (1,'05-2732892','600嘉義市西區新民路580號','嘉大資管');
...
INSERT INTO `product` VALUES (1,'海倫仙度絲經典清潔去屑洗髮乳',1000,599,1,50),(2,'海倫仙度絲 科研去屑洗髮精',1077,799,1,50),(3,'逸萱秀 精油修護潤髮乳',400,253,2,50);
...
INSERT INTO `supplier` VALUES (1,'都都行國際事業股份有限公司','臺北市南港區八德路4段768巷7號地下樓之1','蔡清池','02-26511800'),(2,'都都行有限公司','臺北市南港區八德路4段768巷5號6樓之1','蕭郭金葉','02-26516707');
...
INSERT INTO `user` VALUES (1,'admin','00000000','sys_admin','admin'),(2,'A001','0000','Agent001','agent'),(10,'sugar0504','sugar0504','sugar','agent');
...
-- Dump completed on 2025-06-12  0:49:10
